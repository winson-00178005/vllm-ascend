...
# ST 框架配置路径
_ST_CONFIG_PATH = Path(__file__).parent.parent.parent / "tests" / "e2e" / "st_config" / "test_suites.yaml"

# smart_ut 分支配置路径（向后兼容）
...
_DEFAULT_CONFIGS: list[tuple[Path, str | None]] = [
    (_ST_CONFIG_PATH, None),  # ST 框架配置（优先）
    (_CONFIG_PATH, None),     # smart_ut 分支配置
